...
- Crie sua própria chave na [OpenAI platform](https://platform.openai.com/), depois crie um arquivo .env.local na raiz do projeto com a configuração OPENAI_API_KEY=sua_chave
